...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("[Register] Submitting with:", {
        name: formData.name,
      ...
      if (result.success) {
        console.log("[Register] Success! Navigating to /auth/login");
        navigate("/auth/login");
      } else {
        console.error("[Register] Register failed:", result.error);
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-8 p-16!">
          <Input
